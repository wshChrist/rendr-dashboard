...
import { WithdrawalsMobileView } from './withdrawals-mobile-view';
  ...
  return (
    <div className='w-full max-w-full space-y-4 overflow-x-hidden'>
      ...
      >
        ...
        <div className='flex flex-shrink-0 items-center gap-2'>
          <span className='text-muted-foreground text-sm whitespace-nowrap'>
            {filteredRows.length} {t('pages.withdrawals.withdrawal')}
      ...
      <div className='space-y-4 md:hidden'>
        <WithdrawalsMobileView data={paginatedData} />
      ...
      {table.getFilteredRowModel().rows.length > 0 && (
        ...
        >
          <div className='flex min-w-0 items-center gap-2'>
            ...
            >
              <SelectTrigger className='h-8 w-full max-w-[70px] flex-shrink-0 border-white/10 bg-white/5'>
                <SelectValue
